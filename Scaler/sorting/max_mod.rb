require '../'
=begin
https://www.scaler.com/academy/mentee-dashboard/class/26917/assignment/problems/1013/hints?navref=cl_pb_nv_tb
Problem Description
...
# puts Solution.new.solve([1, 2, 44, 3])
puts Solution.new.solve([927, 707, 374, 394, 279, 799, 878, 937, 431, 112])